...
Data are readily loaded from the dataset provided with this package
...
plotscores(mod, an=list(Class=metadata$Class), title = 'PCA')
plotload(mod, Xn, ppm, title='PCA loadings PC 1')
plotload(mod, Xn, ppm, title='PCA loadings PC 2', pc = 2)
```
