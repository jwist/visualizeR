...
```{r, fig.show='hold'}                                  
compositionMatrix <- read.csv2('/home/jul/git/visualizeR_root/visualizerExamples/datasets9/compositionMatrix.csv', sep = ',', dec = '.', header = FALSE)
...
```{r, fig.show='hold'}  
dataset <- read.csv2('/home/jul/git/visualizeR_root/visualizerExamples/datasets9/dataset.csv', sep = ',', dec = '.', header = FALSE)
```
